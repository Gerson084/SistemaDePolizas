        ...
        <div className="row g-3">
          <div className="col-md-6">
            <div className="card h-100 border-primary">
              <div className="card-body">
                <h5 className="card-title text-primary">Total de Pólizas</h5>
          ...
          <div className="col-md-6">
            <div className="card h-100 border-success">
              <div className="card-body">
                <h5 className="card-title text-success">Promedio de Primas</h5>
                <p className="display-6">${estadisticas.promedioPremas.toFixed(2)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6">
            <div className="card h-100 border-warning">
              <div className="card-body">
                <h5 className="card-title text-warning">Tipo Más Asegurado</h5>
          ...
          <div className="col-md-6">
            <div className="card h-100 border-danger">
              <div className="card-body">
                <h5 className="card-title text-danger">Póliza Más Alta</h5>
                {estadisticas.polizaMasAlta && (
                  <>
                    <p className="fs-5 mb-1">{estadisticas.polizaMasAlta.nombre}</p>
                    <p className="fs-6 mb-0">${estadisticas.polizaMasAlta.primaAnual.toFixed(2)}</p>
          ...
          <div className="col-md-6">
            <div className="card h-100 border-info">
              <div className="card-body">
                <h5 className="card-title text-info">Sin Accidentes</h5>
          ...
          <div className="col-md-6">
            <div className="card h-100 border-warning">
              <div className="card-body">
                <h5 className="card-title" style={{ color: '#ff6b6b' }}>Riesgo Alto/Crítico</h5>
